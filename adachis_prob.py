...
anstxtpath = "/home/nozaki/speaker_clustering/news_kotae/{0}/re_anchor{1}.txt".format(single_filename,2)
anslist = ivmodule.read_ansfile(anstxtpath)
acc,recall,precision,f_measure = ivmodule.test(filelist,anslist,cluster4)
