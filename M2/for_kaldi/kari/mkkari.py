...
for i,newsname in enumerate(newslist):
	...
	for j in range(newsnum[i]):
		...
		f_test_spk2utt.write(" {}_{:04d}".format(newsname,j+1))
		fukunaga_spk2utt.write(" {}_{:04d}".format(newsname,j+1))
		...
		if(roop_cnt == bunkatu and now_dic != 7):
			...
			roop_cnt = 1
		fmv.write("cp /home/nozaki/newsdata/cutwav/vdet_wav/{}_{:04d}.wav ./dic/{}/{}{}/{}{}_{:04d}.wav\n".format(newsname,j+1,newsname,newsname,now_dic,newsname,now_dic,j+1))
		...
		f_test_trans.write("{}_{:04d} {}\n".format(newsname,j+1,test_trans))
		f_test_utt2spk.write("{}{}_{:04d} {}{}\n".format(newsname,now_dic,j+1,newsname,now_dic))
		f_vocab_test.write(vocab_test)

		fukunaga_text.write("{}_{:04d} {}".format(newsname,j+1,word3))
		fukunaga_wav_scp.write("{}{}_{:04d} cat /work/speech_recognition/kaldi/egs/csj/newsdata/{}/{}{}/{}{}_{:04d}.wav |\n".format(newsname,now_dic,j+1,newsname,newsname,now_dic,newsname,now_dic,j+1))
		fukunaga_utt2spk.write("{}{}_{:04d} {}{}\n".format(newsname,now_dic,j+1,newsname,now_dic))
		fukunaga_0txt.write("{}{}_{:04d}\n".format(newsname,now_dic,j+1))